...
function CartPage() {
  ...
  return (
    <div className="p-6 pt-20 max-w-3xl mx-auto dark:bg-gray-900 dark:text-white rounded-2xl shadow-2xl bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 mt-16">
      <h1 className="text-4xl font-extrabold mb-8 text-gray-900 dark:text-white text-center tracking-tight">
        Your Cart
      </h1>
        ...
        {cartItems.map((item) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-blue-600 font-bold dark:text-blue-400 text-lg">
                {item.price} ETB
              </p>
