...
function SignUpPage() {
  ...
  useEffect(() => {
    if (registrationSuccess) {
      ...
      // Redirect to login immediately with state message so login page can display it
      navigate("/login", {
        replace: true,
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-gray-900 px-4 pt-20">
