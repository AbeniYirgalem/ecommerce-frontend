    ...
    <div className="px-4 sm:px-6 md:px-10 pt-20 pb-10 bg-gray-50 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-200">
      <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-xl px-6 sm:px-10 py-10">
        ...
        <p className="mb-6 text-base sm:text-lg text-gray-800 dark:text-gray-300">
          UniBazzar is a digital platform built to empower Ethiopian university
          students by streamlining campus commerce and community connection.
          Whether you're buying a second-hand textbook, offering tutoring
          services, listing your cafe menu, or connecting with other students --
        ...
        <div className="flex items-start gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
              To create a connected and self-sustaining university ecosystem
              where students can thrive academically, socially, and economically
              through peer-to-peer commerce and collaboration.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 mb-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
              UniBazzar is designed for Ethiopian university students who want
              to buy, sell, connect, and collaborate within their campus
              community. Whether you're a student entrepreneur, tutor, buyer, or
              simply looking to engage with others, UniBazzar is for you.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mt-8">
          {[
            ...
            },
            {
              ...
              desc: "Cafes and student-run shops can list their menus and items for on-campus discovery.",
            },
            {
              Icon: FaHandshake,
            ...
            >
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-700 dark:text-gray-100 mb-1">
                  {title}
                </h3>
        ...
        <div className="mt-10 bg-blue-50 dark:bg-blue-900 border border-blue-100 dark:border-blue-700 rounded-xl p-6 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
            Ready to elevate your campus experience? Sign up, explore, and
            connect today.
          </p>
          <button
